const productList = [
  {
    ...
    category: "keyboard",
    description:
      "Dominate on a different scale with the Razer Huntsman Mini a 60% gaming keyboard with cutting-edge Razer Optical Switches. Highly portable and ideal for streamlined setups, it is time to experience lightning-fast actuation in our most compact form factor yet.",
    price: 69.99,
  ...
  },
  {
    ...
    category: "keyboard",
    description:
      "Paint your play in a truly immersive light with the Razer Cynosa V2—the essential RGB gaming keyboard. With customizable lighting in every key, watch it come alive as you game on Chroma-integrated titles, and embrace a gaming experience you wont ever want to turn away from.",
    price: 79.99,
  ...
  },
  {
    ...
    category: "keyboard",
    description:
      "Feel the difference with the Razer BlackWidow V3—backed by a legacy as the first and most iconic mechanical gaming keyboard, and armed with new, improved features including our world-renowned switches.",
    price: 74.99,
  ...
  },
  {
    ...
    category: "keyboard",
    description:
      "Featuring the fastest and most durable Romer-G switches in a compact and ultra-portable ten keyless design, plus advanced performance built in: customizable Logitech RGB color lighting and lighting patterns, game mode button to disable Windows key and avoid accidental actuation, macros to execute complex commands in a single keystroke, 87 key anti-ghosting and 26-key rollover for precision control, and onboard memory to store your lighting configuration. This is the wired Logitech keyboard designed to give you the competitive edge.",
    price: 49.99,
  ...
  },
  {
    ...
    category: "keyboard",
    description:
      "G513 is a high-performance gaming keyboard featuring your choice of advanced GX mechanical switches. The detachable, memory-foam palmrest and premium aluminum-alloy construction make G513 full-featured and best-in-class.",
    price: 79.99,
  ...
  },
  {
    ...
    category: "mouse",
    description:
      "G502 Lightspeed features an advanced optical sensor for maximum tracking accuracy, customizable RGB lighting, custom game profiles, from 200 up to 25,600 DPI, and repositionable weights.",
    price: 59.99,
  ...
  },
  {
    ...
    category: "mouse",
    description:
      "G305 is a LIGHTSPEED wireless gaming mouse designed for serious performance with latest technology innovations at an affordable price point. Now in a variety of vibrant colors.",
    price: 39.99,
  ...
  },
  {
    ...
    category: "mouse",
    description:
      "The most comfortable ergonomic RGB gaming mouse. Packed with a full suite of ultra-premium features into an impossibly lightweight, ergonomic frame.",
    price: 49.0,
  ...
  },
  {
    ...
    category: "monitor",
    description:
      "23.6-inch Full HD (1920 x 1080) 1500R gaming monitor with ultra-fast 165Hz refresh rate (supports 144Hz) designed for professional gamers and immersive gaming",
    price: 141.0,
  ...
  },
  {
    ...
    category: "monitor",
    description:
      "Expand your limits and take your level of play further. The 24 LG UltraGear monitor allows you to view your game at 144Hz/s with a response time of 1Ms. Includes FreeSync.",
    price: 249.0,
  ...
  },
  {
    ...
    category: "webcam",
    description:
      "C920s delivers remarkably crisp and detailed Full HD video (1080p at 30fps) with a full HD glass lens, 78° field of view, and HD auto light correction—plus dual mics for clear stereo sound. Everything you need to look great in conference calls and record polished demos. The attachable privacy shutter protects the lens and keeps your privacy when you need it.",
    price: 72.0,
  ...
  },
  {
    ...
    category: "webcam",
    description:
      "C930e is an advanced HD 1080p webcam that delivers high-resolution video in virtually any environment, including low-light and harshly backlit settings. H.264 video compression and a generously wide 90° field of view help make C930e the next best thing to being there in person.",
    price: 92.0,
  ...
  },
  {
    ...
    category: "webcam",
    description:
      "Logitech StreamCam streams and records in full HD 1080p resolution at 60 fps, delivering stunning video content with smooth motion to every aspect of your online world. From recording YouTube videos to streaming on Twitch and beyond, StreamCams premium glass lens and smart auto-focus system make it easy to get professional-quality results. Advanced features like auto-framing and intelligent exposure ensure you always look your best in any lighting",
    price: 150.0,
  ...
  },
  {
    ...
    category: "microphone",
    description:
      "When it comes to communicating with your fans, friends or family, clarity is key. Whether you are a streamer looking to produce quality content, or someone who requires a solid video call setup for everyday communication, say it loud and clear with the Razer Seirēn X.",
    price: 39.0,
  ...
  },
  {
    ...
    category: "microphone",
    description:
      "Whether it is big-time broadcasting, professional podcasts or critical studio recordings, this legendary dynamic microphone delivers smooth, warm vocals every time. The SM7B captures and enhances the finer details of the human voice while blocking out all the distractions.",
    price: 489.99,
